...
//      2.Create a JSON Model and set the data
            ...
            xmlHttp.open("GET", this.serviceHost+"lights/switchcount/last", true);
...
//      Set Viz properties
        ...
        setPowerViz: function (from, to) {
            ...
            oModel.loadData(this.serviceHost+"lights/power/" + oDateFormat.format(from) + "/" + oDateFormat.format(to));
        },
...
//      2.Create a JSON Model and set the data
        ...
        setHTemperatureViz: function (from, to) {
            ...
            oModel.loadData(this.serviceHost+"lights/temperature/" + oDateFormat.format(from) + "/" + oDateFormat.format(to) +"/max");
            oVizFrame.setModel(oModel);
        },
...
//      2.Create a JSON Model and set the data
            ...
            var xmlHttp = new XMLHttpRequest();
            xmlHttp.open("GET", this.serviceHost+"lights/operatingtime/last", true); // false for synchronous request
            xmlHttp.onload = function (e) {
                if (xmlHttp.readyState === 4) {
                    if (xmlHttp.status === 200) {
                        var data = JSON.parse(xmlHttp.responseText);
        ...
        setLTempViz: function (id, from, to) {
            ...
            var oModel = new JSONModel();
            var url = this.serviceHost+"lights/"+id+"/temperature/" + oDateFormat.format(from) + "/" + oDateFormat.format(to);
...
//      2.Create a JSON Model and set the data
        ...
        setLPowerViz: function (id, from, to) {
            ...
            var oModel = new JSONModel();
            var url = this.serviceHost+"lights/"+id+"/power/" + oDateFormat.format(from) + "/" + oDateFormat.format(to);
            oModel.loadData(url);
            oVizFrame.setModel(oModel);
        },
...
//      2.Create a JSON Model and set the data
        ...
        initLOverview: function (id) {
            ...
            var xmlHttp = new XMLHttpRequest();
            xmlHttp.open("GET", this.serviceHost+"lights/"+id+"/operatingtime/last", true); // false for synchronous request
            ...
            xmlHttp2.open("GET", this.serviceHost+"lights/"+id+"/switchcount/last", true); // false for synchronous request
...
//      2.Create a JSON Model and set the data
            ...
            var xmlHttp = new XMLHttpRequest();
            xmlHttp.open("GET", this.serviceHost+"groups/"+id+"/operatingtime/last", true); // false for synchronous request
            xmlHttp.onload = function (e) {
                if (xmlHttp.readyState === 4) {
                    if (xmlHttp.status === 200) {
                        var data = JSON.parse(xmlHttp.responseText);
...
//      2.Create a JSON Model and set the data
            ...
            var xmlHttp = new XMLHttpRequest();
            xmlHttp.open("GET", this.serviceHost+"groups/"+id+"/switchcount/last", true); // false for synchronous request
            xmlHttp.onload = function (e) {
                if (xmlHttp.readyState === 4) {
                    if (xmlHttp.status === 200) {
                        var oModel = new JSONModel();
...
//      Set Viz properties
        ...
        setGHTemperatureViz: function (id, from, to) {
            ...
            oModel.loadData(this.serviceHost+"groups/"+id+"/temperature/"+ oDateFormat.format(from) + "/" + oDateFormat.format(to) + "/max");
            oVizFrame.setModel(oModel);
        },
...
//      2.Create a JSON Model and set the data
        ...
        setGPowerViz: function (id, from, to) {
            ...
            oVizFrame.setModel(oModel);
            oModel.loadData(this.serviceHost+"groups/"+id+"/power/" + oDateFormat.format(from) + "/" + oDateFormat.format(to));
        },
